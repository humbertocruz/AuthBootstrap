<?php
	...
	echo $this->Form->input('AbUsuario.nome', array('div'=>'form-group','class'=>'form-control'));
	echo $this->Form->input('AbUsuario.usuario', array('label'=>'Usuário','div'=>'form-group','class'=>'form-control'));
	echo $this->Form->input('AbUsuario.senha', array('value'=>'', 'type'=>'password','div'=>'form-group','class'=>'form-control'));

	echo $this->Form->input('AbGruposUsuario.grupo_id', array('type'=>'select','div'=>'form-group','class'=>'form-control','options'=>$AbGrupos));

	echo $this->Form->input('AbUsuario.ativo', array('type'=>'checkbox','div'=>'checkbox','class'=>'checkbox'));
